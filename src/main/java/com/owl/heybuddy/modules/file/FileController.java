...
public class FileController {
	...
	public String fileView(@ModelAttribute("vo") FileVo vo, File dto, Model model, HttpSession httpSession)
			throws Exception {
	...
	public String fileInst2(FileVo vo, Model model, File dto, RedirectAttributes redirectAttributes,
			HttpSession httpSession) throws Exception {
	...
	public String fileEditTemp(@ModelAttribute("vo") FileVo vo, File dto, Model model, HttpSession httpSession)
			throws Exception {
	...
	public String fileInstTemp(FileVo vo, Model model, File dto, RedirectAttributes redirectAttributes,
			HttpSession httpSession) throws Exception {
		service.updateDocument(dto);
	...
	public String commentNele(File dto, FileVo vo, HttpSession httpSession, RedirectAttributes redirectAttributes)
			throws Exception {
	...
	public String fileInst3(FileVo vo, Model model, File dto, RedirectAttributes redirectAttributes,
			HttpSession httpSession) throws Exception {
	...
	public String fileInst4(FileVo vo, Model model, File dto, RedirectAttributes redirectAttributes,
			HttpSession httpSession) throws Exception {

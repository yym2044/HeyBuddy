						...
						<div
							...
							<div class="content-right-header card-header px-4 border-bottom">
								...
								<div class="me-auto d-flex align-items-center">
									...
									<div>
										<h5 class="mb-0 lh-1" id="myName"><c:out value="${sessName}"/></h5>
...
<script type="module">
	  ...
	  const firebaseConfig = {
	    apiKey: "AIzaSyBtzrPDADQk_q-DoUbDk-SGSgQI9pAjEEM",
	    authDomain: "heybuddy-8b499.firebaseapp.com",
	    databaseURL: "https://heybuddy-8b499-default-rtdb.firebaseio.com",
	    projectId: "heybuddy-8b499",
	    storageBucket: "heybuddy-8b499.appspot.com",
	    messagingSenderId: "137320182694",
	    appId: "1:137320182694:web:a4a152c4704d62a3d89567",
	    measurementId: "G-T0W5S46BBB"
	  };

...
<link rel="stylesheet" href="assets/css/style.min.css"
	id="switchThemeStyle">
<!-- 주소창아이콘 -->
<link rel="shortcut icon" href="https://ifh.cc/g/hTTRML.png"
	type="image/x-icon" />
...
<body>
					...
					<div class="position-sticky top-0 mb-2 px-4 px-lg-8 z-index-fixed">
						<div
							...
							<div class="flex-grow-1">
								<a href="fileListTemp" data-bs-placement="top"
								...
								<div class="row justify-content-md-between">
									...
									<div class="col-md-12 mb-3">
										제목 <input type="text" class="form-control" name="hydcTitle"
											placeholder="" value="<c:out value="${item.hydcTitle}"/>"
											required>
									...
									<div class="col-md-12 mb-3">
										<div class="form-floating">
											내용 <input type="text" class="form-control"
												...
												name="hydcText" value="<c:out value="${item.hydcText}"/>"
												required>
									...
									<div class="row">
										<div class="col-md-12 mb-3">
											<label for="file0" class="form-label input-file-button">
												첨부파일 <i data-feather="paperclip" class="fe-1x "></i>
											</label>
	...
	<script type="text/javascript">
		...
		addUploadLi = function(seq, index, name) {
			...
			li = li + name;
			li = li
					+ '<span style="cursor : pointer;" class="badge bg-danger rounded-pill" onClick="delLi('
					+ seq + ',' + index + ')">X</span>';
			li = li + '</li>';

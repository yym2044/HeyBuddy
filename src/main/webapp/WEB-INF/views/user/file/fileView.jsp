					...
					<div class="px-4 position-relative px-lg-8 mb-4 h-100 flex-grow-1">
						<div class="card h-100">
							<div class="card-header">
								<div class="row justify-content-md-between">
										...
										<div class="flex-1 ms-2">
											...
											<a class="text-800 fs--1" href="#!">
												...
												<span class="ms-1 text-500">
													&lt;
													<c:out value="${item.hymmEmail}"></c:out>
													&gt;
												</span>
											</a>
										</div>
									...
									<div class="col-md-auto ms-auto justify-content-md-end d-flex align-items-center">
										<a href="#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Print" class="d-inline-block me-3">
								...
								<div class="d-flex flex-wrap">
									...
									<a href="#!" class="card-hover me-2 position-relative width-90">
										<span class="hover-image mb-1 position-relative d-block overflow-hidden rounded-3">
											<img src="/resources/user/images/profileDefault.png" class="img-fluid" alt="">
							...
							<div class="d-flex mb-3 align-items-center small">
								...
								<!--Comments-->
								<a href="#!" class="d-flex align-items-center btn btn-sm btn-white border rounded-2 px-2 ms-auto">
									<i data-feather="message-square" class="fe-1x me-1 align-middle"></i>
									<span>3</span>
								</a>

								<!--Shares-->
								<a href="#!" class="d-flex align-items-center btn btn-sm btn-white border rounded-2 px-2 ms-1">
							...
							<ul class="list-group">
								<li class="list-group-item">
									<div class="d-flex align-items-stretch">
										<a href="#!" class="flex-shrink-0 d-block me-2">
											<img src="/resources/assets/media/avatars/01.jpg" class="avatar sm rounded-circle" alt="">
										</a>
										...
										<div>
											...
											<div class="d-flex align-items-stretch">
												...
												<a href="#!" class="flex-shrink-0 d-block me-2">
													<img src="/resources/assets/media/avatars/02.jpg" class="avatar xs rounded-circle" alt="">
												</a>
												<!--Reply-->
												<div>
													<div class="py-2 mb-1 px-3 bg-body rounded-3">
								...
								<li class="list-group-item">
									<div class="d-flex align-items-stretch">
										<a href="#!" class="flex-shrink-0 d-block me-2">
											<img src="/resources/assets/media/avatars/03.jpg" class="avatar sm rounded-circle" alt="">
										</a>
										<!--Coomments and replies-->
										<div>
											<div class="py-2 mb-1 px-3 bg-body rounded-3">
								...
								<li class="list-group-item bg-body">
									<!--Add comment-->
									<h6>Add new comment</h6> <textarea name="addComment" rows="2" class="form-control mb-2"></textarea>
									<div class="text-end">

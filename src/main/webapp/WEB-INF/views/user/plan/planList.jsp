					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<a href="javascript:goNele(<c:out value="${rt.hyplSeq}"/>)" type="button" class="btn btn-danger">삭 제</a>
...
<!-- 								<input type="submit" class="btn btn-primary me-2" id="" name="" value="수정하기"> -->
								<a class="btn btn-danger" style="float: left" data-bs-toggle="modal" data-bs-target="#staticBackdrop">삭제하기</a> 

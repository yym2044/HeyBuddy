...
<body>
						...
						<div class="modal-content">
							...
							<div class="modal-footer planinst container">
								<a class="btn btn-danger me-2"
									...
									data-bs-dismiss="modal">취소</a> <input type="submit"
									class="btn btn-primary me-2"
									style="width: 100px; font-size: 1em; text-align: center; float: right;"
									id="btnSubmit" value="등록하기">
							</div>
						</div>
					</div>
				</div>
	...
	<script>
		...
		const exampleEvents = [ {
			...
			title : '<c:out value="${item.hyplName}"/>',
			/*   start: `${currentYear}-${currentMonth}-01`, */
			start : '2022-05-02',
			backgroundColor : cGreen,
			borderColor : cGreen,
		}, {
			title : console.log("${item.hyplName}"),
			/*   start: `${currentYear}-${currentMonth}-01`, */
			start : '2022-05-03',
			backgroundColor : cGreen,
			borderColor : cGreen,

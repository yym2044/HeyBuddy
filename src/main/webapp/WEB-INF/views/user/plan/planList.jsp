		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<main class="page-content d-flex flex-column flex-row-fluid">
				...
				<div class="row planinst container">
					<a class="btn btn-primary" href="heyBuddyPlanForm.html"
						style="width: 130px; text-align: center; margin-left: 30px; margin-bottom: 5px;">일정등록</a>
					<a class="btn btn-secondary" href="#"
						style="width: 130px; text-align: center; margin-left: 30px; margin-bottom: 5px;">일정변경</a>
					<a class="btn btn-danger plandele" href="#"

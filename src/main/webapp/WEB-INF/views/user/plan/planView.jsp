...
<!--                       <div class="content py-4 px-4 px-lg-8 d-flex flex-column-fluid">
                    ...
                    <!-- 	<h5>제목</h5>
                    	...
                    	<br> -->
                    	<h5>기한</h5>
                    	<a class="form-control mb-3" type="text" id="" name=""  placeholder="기한을 등록해주세요" readOnly><img src="calendar.png" style="width: 50px; height: 50px;"></a>
                    	<br><br>
                    	<h5>공유자추가</h5>
                   	     <div class="col-12">
                            <div class="card card-body">
					...
					Modal
                    	...
                    	<br>
                    	<a class="btn btn-danger me-2" href="heyBuddyPlanList.html" style="width: 60px; font-size: 1em; text-align: center; float: right;">삭제</a>
                    	</div>
                    </div>

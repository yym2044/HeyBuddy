									...
									<div class="table-responsive">
										<div class="text-center">
											<label for="profilePhoto" style="cursor: pointer;">
												...
												<img src="assets/media/avatars/08.jpg" class="avatar rounded-pill flex-shrink-0" alt="Customer">
											</label>
										...
										<table id="setTable" class="table table-sm table-nowrap table-card text-center">
											<tr>
												...
												<td><input type="text" class="form-control" placeholder="로그인 시 사용할 아이디" value="yym2044"></td>
											</tr>
											<tr>
												<td>이름</td>
												<td><input type="text" class="form-control" placeholder="이름(50자 이하)" value="윤영민"></td>
											</tr>
											<tr>
												<td>휴대전화</td>
												<td><input type="text" class="form-control" placeholder="전화번호" value="010-1234-5678"></td>
											</tr>
											<tr>
												<td>유선전화</td>
											...
											<tr>
												<td>이메일</td>
												<td><input type="text" class="form-control" placeholder="이메일" value="yym2044@naver.com"></td>
											</tr>
											<tr>
												<td>생일</td>
												<td>
											...
											<tr>
												<td>상태메세지</td>
												<td><input type="text" class="form-control" placeholder="상태메세지(50자 이하)" value="Hi, I'm fine thank you."></td>
											</tr>
										</table>
										<div class="text-center pb-4">
											<a class="btn btn-secondary" href="heyBuddyHostMenu3View.html">취소</a>
											<a class="btn btn-info" href="heyBuddyHostMenu3View.html">등록</a>
										</div>
									</div>
								</div>
							</div>

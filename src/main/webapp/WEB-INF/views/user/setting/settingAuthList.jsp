								...
								<div class="card mb-4 p-3">
									...
									<div class="row px-3 pb-1 d-flex">
										...
										<div class="col-3 text-end">
											<a class="btn btn-outline-danger" href="heyBuddyHostMenu5Form.html">관리자 추가</a>
										</div>
									</div>	
										
									<div class="table-responsive">
										<table id="setTable"
											class="table table-sm table-nowrap table-card table-borderless">
											<thead>
											...
											<tbody>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<img src="assets/media/avatars/08.jpg" class="avatar sm rounded-pill me-3 flex-shrink-0" alt="Customer">
															<div class="h6 mb-0 lh-1 d-flex align-items-center">
																<a href="#modalMember3" data-bs-toggle="modal">윤영민</a><span class="badge bg-danger ms-1">S</span>
															</div>
														</div>
													</td>
													<td>스페이스 환경(2), 스페이스 멤버(3)</td>
													<td><a href="">호스트 변경</a></td>
												</tr>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<img src="assets/media/avatars/03.jpg" class="avatar sm rounded-pill me-3 flex-shrink-0" alt="Customer">
													...
													<td>스페이스 멤버(3)</td>
													<td><a
														class="btn btn-info position-relative p-0 size-30 justify-content-center align-items-center d-inline-flex"
														href="heyBuddyHostMenu5Edit.html"> <i class="bi bi-pencil-square"></i>
													</a> <a
														class="btn btn-danger position-relative p-0 size-30 justify-content-center align-items-center d-inline-flex"
														 data-bs-toggle="modal" data-bs-target="#deleteModal"> <i class="bi bi-trash3"></i>
													</a></td>
												</tr>
											</tbody>
										</table>
